...
require_once '../utils/dompdf/lib/Cpdf.php';
...
$html .= '<center><h2>The Hotel</h2><hr/><h3>Laporan Penerimaan Biaya Sewa Kamar</h3></center><br/>';
...
<div class="container d-flex justify-content-between mt-3">
    <div class="input-group">
        <input type="text" class="form-control" aria-label="Sizing example input"
            aria-describedby="inputGroup-sizing-default" placeholder="tanggal check out">
    </div>
...
<div class="container mt-3 border-top border-primary border-3">
    ...
    <div class="container d-flex justify-content-between mt-3"
        ...
        <form action="" method="post" class="d-flex">
            <input type="number" name="result_record" class="form-control w-25" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" value="10" min="1">
        ...
        <form class="d-flex w-25">
            ...
            <input style="position: absolute; right: -1000px; display: none;" type="text" id="hidden_input"
                value="<?= "transaksi"; ?>">
        </form>
    </div>
            ...
            <tbody>
                ...
                <td>
                    <button type="button" class="btn btn-warning">
                        ...
                        <a href="ubah.php?id=<?= $row["id_transaksi"]; ?>&param1=transaksi&param2=id_transaksi"
                ...
                <td>
                    <button type="button" class="btn btn-danger">
                        ...
                        <a href="hapus.php?id=<?= $row["id_transaksi"]; ?>&param1=transaksi&param2=id_transaksi"
                ...
                <?php $html .= "
                    <tr>
                        ...
                        <th>Rp " . number_format($row['total_biaya_sewa'], '0', '.', '.') . "</th>
                    </tr>";
                ?>
            </tbody>
        </table>
...
<div class="container">
    <form action="" method="post" class="d-flex flex-row-reverse bd-highlight">
        <button type="submit" class="btn btn-primary" id="btn_print" name="print">cetak laporan reservasi kamar
            hotel</button>
        <button type="button" class="btn btn-primary me-4">cetak jurnal buku besar</button>
    </form>
</div>
...
if (isset($_POST['print'])) {
    ...
    $filename = "laporan_reservasi_kamar_hotel";
