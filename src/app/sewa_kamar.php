...
if (isset($_POST["submit"])) {
    ...
    if (tambah_data_sewa_kamar($_POST) > 0) {
        echo "
			<script>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group mb-3">
                            <input type="text" name="id_transaksi" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="id transaksi" required>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="date" name="tanggal_transaksi" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="tanggal transaksi" required>
                        </div>
                        <div class="input-group mb-3">
                            <input type="date" name="tanggal_checkout" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="tanggal checkout" required>
                        </div>
                        <div class="input-group mb-3">
                            <input type="number" name="total_biaya_sewa" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="total biaya sewa" required>
                        </div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning">
                                ...
                                <a href="ubah.php?id=<?= $row["id_transaksi"]; ?>&param1=transaksi&param2=id_transaksi" style="text-decoration: none; color: black;">edit</a>
                            </button>
                        </td>
                        <td>
                            <button type="button" class="btn btn-danger">
                                ...
                                <a href="hapus.php?id=<?= $row["id_transaksi"]; ?>&param1=transaksi&param2=id_transaksi" style="text-decoration: none; color:white;">hapus</a>
                            </button>
                        </td>
                    </tr>
                    <?php $i++; ?>
