...
if (isset($_POST['show_entries'])) {
    // cek apakah data berhasil di tambahkan atau tidak
    if (tampilkan_data($_POST, 'transaksi', 'id_transaksi') > 0) {
        echo "
			<script>
				alert('data berhasil ditambahkan!');
			</script>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning">
                            ...
                            <a href="ubah.php?id=<?= $row["id_transaksi"]; ?>" style="text-decoration: none;">edit</a>
                        </button>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger">
                            ...
                            <a href="hapus.php?id=<?= $row["id_transaksi"]; ?>" style="text-decoration: none;">hapus</a>
                        </button>
                    </td>
                </tr>
                <?php $i++; ?>
