...
if (isset($_POST['show_entries'])) {
    // cek apakah data berhasil di tambahkan atau tidak
    $result = tampilkan_data($_POST, "admin", "id_admin");
}
?>
...
<div class="container mt-3 border-top border-primary border-3">
    <div class="container d-flex justify-content-between mt-3" style="display: flex; align-items: center; height: 40px;">
        ...
        <form class="d-flex w-25">
            ...
            <input style="position: absolute; right: -1000px; display: none;" type="text" id="hidden_input" value="<?= "admin"; ?>">
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="submit" class="btn btn-warning">
                                ...
                                <a href="ubah.php?id=<?= $row["id_admin"]; ?>&param1=admin&param2=id_admin" style="text-decoration: none; color: black;">edit</a>
                            </button>
                        </td>
                        <td>
                            <button type=" submit" class="btn btn-danger">
                                    ...
                                    <a href="hapus.php?id=<?= $row["id_admin"]; ?>&param1=admin&param2=id_admin" style="text-decoration: none; color: white;">hapus</a>
                            </button>
                        </td>
                    </tr>
                    <?php $i++; ?>
