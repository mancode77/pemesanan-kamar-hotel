...
if (isset($_POST['show_entries'])) {
    ...
    if (tampilkan_data($_POST, 'kamar', 'id_kamar') > 0) {
        echo "
			<script>
...
<div class="container d-flex justify-content-between mt-3">
    <div class="input-group">
        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="tanggal check out">
    </div>
...
<div class="container d-flex flex-row-reverse bd-highlight">
    <button type="button" class="btn btn-primary">cetak laporan reservasi kamar hotel</button>
